    ...
    $.extend(true, fd.plugins, {
        formEditor:function(){
            this.init = function(props,k,src,FGroup){
                var data = [{"_id":"551377fa7ac2d3a310c0b561","level":"请选择","extend":"请选择","name":"请假单","attrType":"java.lang.String","attribute":[{"attrType":"java.lang.String","attrName":"申请人","attrCode":"appname"},{"attrType":"java.lang.String","attrName":"申请类型","attrCode":"apptype"},{"attrType":"java.util.List","attrName":"联系方式","attrCode":"appcontact"},{"attrType":"java.util.Map","attrName":"住址","attrCode":"appcontact-addr"},{"attrType":"java.util.Map","attrName":"地址电话","attrCode":"appcontact-addrphone"},{"attrType":"java.util.Map","attrName":"备注","attrCode":"appcontact-beizu"}],"code":"qingjia","type":"obj"}] ; ;
